...
class AdditiveSynthesisBells():

	def main():
		
		#improve - read this list from a file. or receive as system argument. (from console.)
		list_of_frequencies_and_amplitudes = [[500,1],[1200,1],[1800,1],[2400,1],[3000,1],[3600,1],[4200,1],[4800,0.5],[600,0.25],[700,0.25]];
		...
		outputSignal.wav_write('outBells.wav');
