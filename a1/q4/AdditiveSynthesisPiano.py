...
class AdditiveSynthesisPiano():

	def main():
		
		#improve - read this list from a file. or receive as system argument. (from console.)
		list_of_frequencies_and_amplitudes = [[400,0.25],[500,0.75],[1000,0.5],[2000,0.5],[3000,0.5],[4000,0.5],[5000,0.5],[700,1],[650,1],[750,1]];
		...
		outputSignal.wav_write('outPiano.wav');
